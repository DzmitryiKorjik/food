...
function calc() {
        ...
        function getStaticInformayion (selector, activeClass) {
            const elements = document.querySelectorAll(selector);
        ...
        getStaticInformayion('#gender div', 'calculating__choose-item_active');
        getStaticInformayion('.calculating__choose_big div', 'calculating__choose-item_active');
...
window.addEventListener('DOMContentLoaded', function() {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2024-09-16');
